...
import me.bruceli.redis.lock.DistributedLockCallback;
...
public class DistributedLockAspect {
    ...
    @Pointcut("@annotation(me.bruceli.redis.annotation.DistributedLock)")
    ...
    public Object lock(ProceedingJoinPoint pjp, Method method, final String lockName) {
        ...
        if (tryLock) {
            Object tryLockFlag=tryLock(pjp, annotation, lockName, fairLock);
            log.info("lockName={},tryLock={}}",lockName,tryLock);
            return tryLockFlag;
        } else {
